...
4) cd /usr/lib/python2.6/vendor-packages/pkg/flavor and apply the following hacks

   a) cp depthlimitedmf.py depthlimitedmf27.py
   b) Edit python.py and apply the following patch:
--- python.py.orig      2015-07-22 03:24:42.284681464 -0700
+++ python.py   2015-07-21 23:47:54.480653890 -0700
@@ -163,6 +163,7 @@
         deps = []
         errs = []
         path_version = None
